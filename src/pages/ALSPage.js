...
const ALSPage = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen overflow-hidden">
      ...
      {/* Main Content */}
      <div className="pt-20 w-screen max-w-full mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md flex justify-center items-center overflow-hidden">
